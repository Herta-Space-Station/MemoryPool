...
namespace NativeCollections
{
    public static class Tlsf64
    {
        ...
        public static void memcpy(ref byte dst, ref byte src, ulong size) => Unsafe.CopyBlockUnaligned(ref dst, ref src, (uint)size);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong block_size(NativePointer<block_header_t> block) => block.AsRef().size & ~(block_header_free_bit | block_header_prev_free_bit);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void block_set_size(NativePointer<block_header_t> block, ulong size)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint block_to_ptr(NativePointer<block_header_t> block) => block + (nint)block_start_offset;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativePointer<block_header_t> offset_to_block(nint ptr, ulong size) => ptr + (nint)size;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint align_ptr(nint ptr, ulong align)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mapping_insert(ulong size, NativePointer<int> fli, NativePointer<int> sli)
        {
            int fl, sl;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mapping_search(ulong size, NativePointer<int> fli, NativePointer<int> sli)
        {
            if (size >= SMALL_BLOCK_SIZE)
            {
        ...
        public static NativePointer<block_header_t> search_suitable_block(NativePointer<control_t> control, NativePointer<int> fli, NativePointer<int> sli)
        {
            ...
            sl = tlsf_ffs(sl_map);
            sli.AsRef() = sl;
            return Unsafe.Add(ref Unsafe.As<ulong, NativePointer<block_header_t>>(ref control.AsRef().blocks.get(fl)), (nint)sl);
        }
        ...
        public static void remove_free_block(NativePointer<control_t> control, NativePointer<block_header_t> block, int fl, int sl)
        {
            ...
            if (Unsafe.Add(ref Unsafe.As<ulong, NativePointer<block_header_t>>(ref control.AsRef().blocks.get(fl)), (nint)sl) == block)
            {
                Unsafe.Add(ref Unsafe.As<ulong, NativePointer<block_header_t>>(ref control.AsRef().blocks.get(fl)), (nint)sl) = next;
        ...
        {
            var current = Unsafe.Add(ref Unsafe.As<ulong, NativePointer<block_header_t>>(ref control.AsRef().blocks.get(fl)), (nint)sl);
            ...
            Unsafe.Add(ref Unsafe.As<ulong, NativePointer<block_header_t>>(ref control.AsRef().blocks.get(fl)), (nint)sl) = block;
            control.AsRef().fl_bitmap |= 1U << fl;
            Unsafe.Add(ref Unsafe.As<sl_bitmap_t, uint>(ref control.AsRef().sl_bitmap), (nint)fl) |= 1U << sl;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int block_can_split(NativePointer<block_header_t> block, ulong size) => block_size(block) >= (ulong)Unsafe.SizeOf<block_header_t>() + size ? 1 : 0;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativePointer<block_header_t> block_split(NativePointer<block_header_t> block, ulong size)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void block_trim_free(NativePointer<control_t> control, NativePointer<block_header_t> block, ulong size)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void block_trim_used(NativePointer<control_t> control, NativePointer<block_header_t> block, ulong size)
        {
            if (block_can_split(block, size) != 0)
            {
                var remaining_block = block_split(block, size);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativePointer<block_header_t> block_trim_free_leading(NativePointer<control_t> control, NativePointer<block_header_t> block, ulong size)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativePointer<block_header_t> block_locate_free(NativePointer<control_t> control, ulong size)
        {
            int fl = 0, sl = 0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint block_prepare_used(NativePointer<control_t> control, NativePointer<block_header_t> block, ulong size)
        {
            nint p = 0;
            if (block != 0)
            {
        ...
        public static void control_construct(NativePointer<control_t> control)
        {
            ...
            for (i = 0; i < FL_INDEX_COUNT; ++i)
            {
                ...
                for (j = 0; j < SL_INDEX_COUNT; ++j)
                    Unsafe.Add(ref Unsafe.As<ulong, NativePointer<block_header_t>>(ref control.AsRef().blocks.get(i)), (nint)j) = NativePointer<block_header_t>.Create(ref control.AsRef().block_null);
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong tlsf_block_size(nint ptr)
        {
            ulong size = 0;
            if (ptr != 0)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint tlsf_add_pool(nint tlsf, nint mem, ulong bytes)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint tlsf_create_with_pool(nint mem, ulong bytes)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint tlsf_malloc(nint tlsf, ulong size)
        {
            var control = (NativePointer<control_t>)tlsf;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint tlsf_memalign(nint tlsf, ulong align, ulong size)
        {
            var control = (NativePointer<control_t>)tlsf;
            var adjust = adjust_request_size(size, ALIGN_SIZE);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint tlsf_realloc(nint tlsf, nint ptr, ulong size)
        {
            var control = (NativePointer<control_t>)tlsf;
            nint p = 0;
            if (ptr != 0 && size == 0)
        ...
        public struct sl_bitmap_t
        {
            ...
            public sl_bitmap_t_16 element1;
            public sl_bitmap_t_8 element2;
        ...
        public static ref ulong get(ref this blocks_t src, int index) => ref Unsafe.Add(ref Unsafe.As<blocks_t, ulong>(ref src), index);
