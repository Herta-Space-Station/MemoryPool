...
namespace NativeCollections
{
    ...
    public readonly struct NativePointer<T> : IEquatable<NativePointer<T>> where T : unmanaged
    {
        /// <summary>
        ///     Handle
        /// </summary>
        ...
        ///     To string
        /// </summary>
        public override string ToString() => $"NativeArray<{typeof(T).Name}>";
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref TTo Cast<TTo>() where TTo : unmanaged => ref Unsafe.AddByteOffset(ref Unsafe.NullRef<TTo>(), _handle);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator nint(NativePointer<T> nativeReference) => nativeReference._handle;

        /// <summary>
        ///     Create
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativePointer<T> Create<TFrom>(ref TFrom reference) where TFrom : unmanaged => new(Unsafe.ByteOffset(ref Unsafe.NullRef<TFrom>(), ref reference));
